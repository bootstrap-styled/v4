...
var propTypes = exports.propTypes = {
   ...
   */
  tag: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.element, _propTypes2.default.func, _propTypes2.default.object]),
  /**
  ...
  _createClass(NavLink, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          Tag = _props.tag,
          ref = _props.ref,
          attributes = _objectWithoutProperties(_props, ['className', 'cssModule', 'active', 'tag', 'ref']);
      ...
      return _react2.default.createElement(Tag, _extends({}, attributes, { ref: ref, onClick: this.onClick, className: classes }));
    }
  }]);
