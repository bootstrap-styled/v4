  ...
  _createClass(ContainerUnstyled, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", _extends({
        className: (0, _classnames.default)(className, 'container')
      }, attributes));
    }
  }]);
...
var Container = (0, _styledComponents.default)(ContainerUnstyled).withConfig({
  ...
  return "\n    ".concat((0, _grid.makeContainer)(props.theme['$enable-grid-classes'], props.theme['$grid-gutter-widths']), "\n    \n    ").concat((0, _grid.makeContainerMaxWidths)(props.theme['$enable-grid-classes'], props.theme['$container-max-widths'], props.theme['$grid-breakpoints']), "\n  ");
});
