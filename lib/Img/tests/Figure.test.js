...
var renderComponent = function renderComponent() {
  ...
  return (0, _enzyme.mount)(_react.default.createElement(_Figure.default, {
...
var renderComponentUsingTheme = function renderComponentUsingTheme() {
  var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return (0, _enzyme.mount)(_react.default.createElement(_BootstrapProvider.default, null, _react.default.createElement(_Figure.default, {
    className: props.className
  }, props.children)));
};
