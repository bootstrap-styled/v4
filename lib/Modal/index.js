...
var propTypes = exports.propTypes = {
  ...
  theme: _propTypes2.default.shape({
    ...
    '$modal-md': _propTypes2.default.string,
    '$modal-dialog-sm-up-margin-': _propTypes2.default.string,
    '$enable-shadows': _propTypes2.default.bool,
    '$modal-content-sm-up-box-shadow': _propTypes2.default.string,
    '$modal-sm': _propTypes2.default.string,
    '$modal-lg': _propTypes2.default.string,
    '$zindex-modal': _propTypes2.default.string,
    '$zindex-modal-backdrop': _propTypes2.default.string,
    '$enable-transitions': _propTypes2.default.bool,
    '$transition-fade': _propTypes2.default.string,
    '$modal-transition': _propTypes2.default.string,
    '$modal-dialog-margin': _propTypes2.default.string,
    '$font-family-base': _propTypes2.default.string,
    '$font-size-base': _propTypes2.default.string,
    '$font-weight-base': _propTypes2.default.string,
    '$line-height-base': _propTypes2.default.string,
    '$body-color': _propTypes2.default.string,
    '$body-bg': _propTypes2.default.string,
    '$$modal-content-bg': _propTypes2.default.string,
    '$modal-content-border-width': _propTypes2.default.string,
    '$modal-content-border-color': _propTypes2.default.string,
    '$enable-rounded': _propTypes2.default.bool,
    '$border-radius-lg': _propTypes2.default.string,
    '$modal-content-xs-box-shadow': _propTypes2.default.string,
    '$modal-backdrop-bg': _propTypes2.default.string,
    '$modal-backdrop-opacity': _propTypes2.default.string,
    '$modal-header-padding': _propTypes2.default.string,
    '$modal-header-border-width': _propTypes2.default.string,
    '$modal-header-border-color': _propTypes2.default.string,
    '$modal-title-line-height': _propTypes2.default.string,
    '$modal-inner-padding': _propTypes2.default.string,
    '$modal-footer-border-color': _propTypes2.default.string
  }),
