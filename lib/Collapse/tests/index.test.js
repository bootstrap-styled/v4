...
describe('<Collapse />', function () {
  ...
  it('should have default isOpen value', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, null));
  ...
  it('should render with class "navbar"', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { navbar: true }));
