...
describe('<PaginationLink />', function () {
  ...
  it('should render previous', function () {
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_PaginationLink2.default, { previous: true }));
  ...
  it('should render next', function () {
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_PaginationLink2.default, { next: true }));
