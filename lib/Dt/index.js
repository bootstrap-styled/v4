...
function (_React$Component) {
  ...
  function DtUnstyled() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DtUnstyled).apply(this, arguments));
  }
...
_defineProperty(DtUnstyled, "propTypes", propTypes);

_defineProperty(DtUnstyled, "defaultProps", defaultProps);

var Dt = (0, _styledComponents.default)(DtUnstyled).withConfig({
  displayName: "Dt",
